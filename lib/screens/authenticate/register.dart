...
import 'package:pictoshare/screens/authenticate/VerificationEmail.dart';
import 'package:pictoshare/services/auth.dart';
import 'package:pictoshare/shared/constants.dart';
          ...
          child: Column(
            children: <Widget>[
              ...
              TextFormField(
                ...
                validator: (val) => val.length < 3 ? "Enter your name" : null,
                obscureText: true,
                onChanged: (val) {
                  setState(() => name = val);
                },
